...
var myhomelistingRouter = require("./api/myhomelistings/myhomelistings.router");
var rentalApplicationsRouter = require("./api/applications/rentalApplications.router");
...
app.use("/myhomelistings", myhomelistingRouter);
app.use("/rentalApplications", rentalApplicationsRouter);
