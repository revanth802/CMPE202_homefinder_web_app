        ...
        <form method="post">
          ...
          <div className="row">
            <div className="col-md-6">
              ...
              <div className="form-group">
              <Button variant="outline-primary" onClick={this.handleAdd}>Update Listing!</Button>
             
              </div>
            </div>
            <div className="col-md-6">
            <div className="form-group">
            <input type="number" name="year" className="form-control" placeholder="Year Built" onChange={this.handleChange}
            ...
            <div className="form-group">
                <input type="number" name="price" className="form-control" placeholder="Price in $" onChange={this.handleChange} defaultValue={this.state.homes.price} />
              </div>
              <div className="form-group">
                <textarea name="terms" className="form-control" placeholder="Terms *" style={{width: '100%', height: '150px'}} onChange={this.handleChange} 
                defaultValue={this.state.homes.terms} />
              </div>
            </div>
          </div>
        </form>
